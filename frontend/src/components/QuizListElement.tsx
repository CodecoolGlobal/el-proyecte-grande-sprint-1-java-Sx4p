...
import {Card, CardActions, CardContent, getTableSortLabelUtilityClass} from "@mui/material";
import Button from "@mui/material/Button";
import WeightIcon from '@mui/icons-material/FitnessCenter';

export default function QuizListElement({name, author, numberOfQuestions, difficulty}: QuizDetails): ReactElement {
